...
class ThemePresets
{
    ...
    public const PRESETS = [
        ...
        'currency_green' => [
            'label' => 'Currency Green',
            'primary_color' => '#059669',
            'primary_hover_color' => '#047857',
            'secondary_color' => '#d97706',
            'secondary_hover_color' => '#b45309',
            'background_color' => '#ffffff',
            'surface_color' => '#f0fdf4',
            'text_primary_color' => '#064e3b',
            'text_secondary_color' => '#6b7280',
        ...
        'midnight_violet' => [
            ...
            'primary_color' => '#7c6cf6',
            'primary_hover_color' => '#6a58f0',
            'secondary_color' => '#8f8bad',
            'secondary_hover_color' => '#6f6b8f',
            'background_color' => '#0d0a17',
            'surface_color' => '#10131f',
            'text_primary_color' => '#ecebf5',
            'text_secondary_color' => '#8f8bad',
            'text_on_primary_color' => '#ffffff',
            'success_color' => '#34d399',
            'warning_color' => '#fbbf24',
            'danger_color' => '#f87171',
            ...
            // Dark-surface set — sampled from the approved reference, not
            // derived: card #10131f, page #0d0a17, border #262b45.
            'surface_page_dark_color' => '#0d0a17',
            'surface_card_dark_color' => '#10131f',
            'surface_input_dark_color' => '#10131f',
            'surface_border_dark_color' => '#262b45',
        ],
        'custom' => [
            'label' => 'Custom',
        ],
