...
@switch($key)
    @case('google')
        <svg {{ $attributes->merge(['class' => $class, 'width' => 20, 'height' => 20]) }} viewBox="0 0 24 24" aria-hidden="true">
    ...
    @case('github')
        <svg {{ $attributes->merge(['class' => $class, 'width' => 20, 'height' => 20]) }} viewBox="0 0 24 24" fill="currentColor" aria-hidden="true">
    ...
    @case('microsoft')
    @case('azure')
        <svg {{ $attributes->merge(['class' => $class, 'width' => 20, 'height' => 20]) }} viewBox="0 0 23 23" aria-hidden="true">
