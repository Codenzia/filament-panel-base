...
@if ($state === 'unavailable')
    <div class="rounded-md bg-warning-50 p-4 text-sm text-warning-800 dark:bg-warning-900/30 dark:text-warning-200">
...
@elseif ($state === 'pending')
    <div class="space-y-5">
        <div class="rounded-md bg-info-50 p-3 text-sm text-info-800 dark:bg-info-900/30 dark:text-info-200">
            {{ __('filament-panel-base::two-factor.pending_intro') }}
        </div>

        <div class="flex flex-col items-center gap-3 rounded-md border border-gray-200 bg-white p-4 dark:border-white/10 dark:bg-gray-900">
...
@elseif ($state === 'enabled')
    <div class="space-y-4">
        <div class="flex items-start gap-3 rounded-md bg-success-50 p-3 text-sm text-success-800 dark:bg-success-900/30 dark:text-success-200">
